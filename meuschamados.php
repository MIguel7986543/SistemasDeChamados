...
<head>
  ...
  <title>Meu chamado</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">
  <link rel="stylesheet" href="php/meuschamados.php">
</head>
<body>
  <div class="container py-4">
    <header class="d-flex align-items-center mb-3">
      <div class="logo d-flex align-items-center gap-2 text-white me-auto">
        <h3 class="m-0">Espere na linha o seu chamado...</h3>
      ...
      <nav class="menu-lateral">
        <ul class="nav1 nav-pills gap-2">
          ...
          <li class="nav-item"><a href="meuschamados.php" class="nav-link active">Recaregar pag</a></li>
